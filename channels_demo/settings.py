...
SECRET_KEY = 'django-insecure-oh+m9qg-bl*5n)kj3=mieob8+l_c^qmkl2j)q$r6)_w6+pbri4'
...
# Make CSRF cookies inaccessible to JavaScript
CSRF_COOKIE_HTTPONLY = True

# Ensure cookies are sent only with first-party requests
